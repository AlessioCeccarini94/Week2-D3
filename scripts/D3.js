...
console.log("nomi personaggi Star Wars", charactersNames)
...
console.log("peso equipaggio", crewMass)
...
// starWarsCharacters[ind].mass = Math.ceil(Math.random() * 300)
// console.log(starWarsCharacters[ind].mass)
...
for (let i = 0; i < femaleCharacters.length; i++) {
  for (let y = 0; i < charactersNames.length; i++) {
    if (femaleCharacters[i] === femaleCharacters[y]) {
...
starWarsCharacters[characters] = Math.random()
